...
By doing this simulation, a distribution of the combination of A and B can be observed. What sort of distribution is critical to establish. Often this is a normal distribution. 

If the result from the test that we did initially happens very seldom in the simulated testing, we have a high significance value.
