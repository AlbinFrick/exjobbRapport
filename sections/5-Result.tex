...
For this project, estimating the time for every given task was challenging. For example, the time needed to create a working prototype for testing was not anticipated. Therefore, when the prototype was functional, and usability tests were done to ensure that other people could use it, there was no time left in the project period to carry out the A/B tests. The A/B tests were instead moved to the future work section.
